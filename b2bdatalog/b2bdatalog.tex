...
with differential evidently not, given that it has its own iteration mechanism, as demonstrated in figure \ref{fig:substitution_simple_ddflow}.

\subsection{Partial Constant-based Indexing}
