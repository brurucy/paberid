...
We propose a straightforward not-recursive pseudocode algorithm to translate a datalog rule into a $SPJ$ expression tree. Nodes in
a $SPJ$ expression tree are relational operators and leaves are relations.
\begin{algorithm} [!h]
	\scriptsize
